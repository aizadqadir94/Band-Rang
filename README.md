...
- Special rule: when the winning bid is exactly **8**, none of the remaining 8 cards dealt to the bidding team will be of the chosen trump suit — every leftover trump goes to the two opponents.
- If the trump setter cannot follow suit before trump is revealed, their waste card is played face down and cannot win the trick. Their partner plays waste cards face up.
